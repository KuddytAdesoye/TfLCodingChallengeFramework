...
namespace TfLCodingChallengeAutomation.StepDefinition
{
    ...
    public class JourneyPlannerSteps
    {
        ...
        [When(@"a user clicks '([^']*)'")]
        public void WhenAUserClicks(string p0)
        {
            journeyResultPage.ClickAccessibilityDetails();
            journeyResultPage.ClickViewDetailsButton();
        }
        ...
        {
            string actualDisplayText = journeyResultPage.ClickAccessibilityDetails();
