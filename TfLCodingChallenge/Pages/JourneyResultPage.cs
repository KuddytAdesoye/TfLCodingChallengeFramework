...
namespace TfLCodingChallengeAutomation.Pages
{
    public class JourneyResultPage
    {
        ...
        By viewDetailsBtn = By.XPath("//*[@id=\"option-1-content\"]/div[1]/div[5]/div[2]/button[1]");
        ...
        {
            context.driver.FindElement(viewDetailsBtn).Click();
        }
        ...
        public string ClickAccessibilityDetails()
        {
